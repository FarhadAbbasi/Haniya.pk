...
export default async function PrintedLawnPage({
  ...
  const products = await getProductsByCategorySlug("printed-lawn", { min, max, q })
  return (
    <div className="mx-auto max-w-7xl px-4 py-12">
      <h1 className="mb-2 text-3xl font-semibold tracking-tight">Printed — Lawn</h1>
      <p className="mb-6 text-muted-foreground">Explore our printed lawn selection.</p>
      <CatalogFilters />
